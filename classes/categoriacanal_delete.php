 ...
 * Page class
 */
class categoriacanal_delete extends categoriacanal
{
	...
	// Page object name
	public $PageObjName = "categoriacanal_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("categoriacanallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("categoriacanallist.php"); // Return to list
			}
		}
	}
