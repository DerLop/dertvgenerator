 ...
 * Page class
 */
class categoriacanal_view extends categoriacanal
{
	...
	// Page object name
	public $PageObjName = "categoriacanal_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "categoriacanallist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "categoriacanallist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "categoriacanallist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
