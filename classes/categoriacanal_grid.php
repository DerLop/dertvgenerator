 ...
 * Page class
 */
class categoriacanal_grid extends categoriacanal
{
	...
	// Page object name
	public $PageObjName = "categoriacanal_grid";

	// Grid form hidden field names
	public $FormName = "fcategoriacanalgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_categoria") && $CurrentForm->hasValue("o_categoria") && $this->categoria->CurrentValue != $this->categoria->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_descripcion") && $CurrentForm->hasValue("o_descripcion") && $this->descripcion->CurrentValue != $this->descripcion->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_urlImagen") && $CurrentForm->hasValue("o_urlImagen") && $this->urlImagen->CurrentValue != $this->urlImagen->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	protected function loadFormValues()
	{
		...
		$this->categoria->setOldValue($CurrentForm->getValue("o_categoria"));
		...
		$this->urlImagen->setOldValue($CurrentForm->getValue("o_urlImagen"));
	}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// urlImagen
			$this->urlImagen->setDbValueDef($rsnew, $this->urlImagen->CurrentValue, "", $this->urlImagen->ReadOnly);
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "canal") {
			$this->id->Visible = FALSE;
			if ($GLOBALS["canal"]->EventCancelled)
