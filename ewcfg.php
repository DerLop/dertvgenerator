...
$CONFIG = [
	...
	"RANDOM_KEY" => 'ulhb8cvBXmAwKcp3', // Random key for encryption
	...
	"PROJECT_ID" => "{628FF872-8546-407C-9BA6-1F54D1486775}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "127.0.0.1", "port" => 3306, "user" => "root", "pass" => "", "db" => "dertv"]
	],
	...
	"ADMIN_USER_NAME" => "derlop", // Administrator user name
	"ADMIN_PASSWORD" => "derlop95", // Administrator password
